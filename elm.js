...
Elm.Common.make = function (_elm) {
   ...
   var PortWait = {ctor: "PortWait"};
   var Run = {ctor: "Run"};
   var emptyBlock = {_: {}
                    ,acc: 0
                    ,bak: 0
                    ,cur: 0
                    ,inPort: $Maybe.Nothing
                    ,instrs: $Array.empty
                    ,labels: $Dict.empty
                    ,mode: Run
                    ,outPort: $Maybe.Nothing
                    ,source: _L.fromArray([])
                    ,waitPort: $Maybe.Nothing};
   var BlockState = function (a) {
      return function (b) {
         return function (c) {
            return function (d) {
               return function (e) {
   ...
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var inverseDirection = function (dir) {
      return function () {
         switch (dir.ctor)
         {case "Any": return Any;
            case "Down": return Up;
   ...
   var NewLine = {ctor: "NewLine"};
   var Label = function (a) {
      return {ctor: "Label",_0: a};
   };
   var ILabel = F2(function (a,b) {
      return {ctor: "ILabel"
             ,_0: a
             ,_1: b};
   });
   var JNZ = function (a) {
      return {ctor: "JNZ",_0: a};
   };
   var JEZ = function (a) {
      return {ctor: "JEZ",_0: a};
   };
   var JLZ = function (a) {
      return {ctor: "JLZ",_0: a};
   };
   var JGZ = function (a) {
      return {ctor: "JGZ",_0: a};
   };
   var JMP = function (a) {
   ...
   var NEG = {ctor: "NEG"};
   var MOVINT = F2(function (a,b) {
      return {ctor: "MOVINT"
             ,_0: a
             ,_1: b};
   });
   var MOV = F2(function (a,b) {
      return {ctor: "MOV"
             ,_0: a
             ,_1: b};
   });
   var DebugInstr = F2(function (a,
   b) {
      return {_: {}
             ,instr: a
             ,line: b};
...
Elm.Main.make = function (_elm) {
   ...
   var resetBlockState = function (s) {
      return _U.replace([["acc",0]
                        ,["cur",0]
                        ,["bak",0]
                        ,["inPort",$Maybe.Nothing]
                        ,["outPort",$Maybe.Nothing]
   ...
   var nextInstruction = function (s) {
      return _U.replace([["cur"
                         ,_U.cmp(s.cur + 1,
                         $Array.length(s.instrs)) > -1 ? 0 : s.cur + 1]],
      s);
   };
   var jumpToLabel = F2(function (label,
   s) {
      return A2($Maybe.withDefault,
      nextInstruction(s),
      A2($Maybe.map,
      ...
      A2($Dict.get,label,s.labels)));
   });
   var conditionalJump = F3(function (cond,
   label,
   s) {
      return A2(cond,
      s.acc,
   ...
   var getPortOrWait = F3(function (func,
   dir,
   s) {
      return function () {
         var wait = _U.replace([["waitPort"
                                ,$Maybe.Just(dir)]
                               ,["mode",$Common.PortWait]],
         s);
         return function () {
            var _v5 = s.inPort;
            switch (_v5.ctor)
            {case "Just":
               switch (_v5._0.ctor)
                 {case "_Tuple2":
                    return _U.eq(dir,
                      _v5._0._0) ? nextInstruction(A2(func,
                      _v5._0._1,
                      _U.replace([["inPort"
                                  ,$Maybe.Nothing]],
                      s))) : wait;}
   ...
   var setPortOrWait = F3(function (value,
   dir,
   s) {
      return _U.eq(s.outPort,
      $Maybe.Nothing) ? _U.replace([["outPort"
   ...
   var evalADD = F2(function (src,
   s) {
      return function () {
         switch (src.ctor)
         {case "Acc":
            return nextInstruction(_U.replace([["acc"
                                               ,s.acc + s.acc]],
              s));
            case "Port":
            return A3(getPortOrWait,
   ...
   var evalInstr = F2(function (x,
   s) {
      return function () {
         switch (x.ctor)
         {case "ADD": return A2(evalADD,
              x._0,
              s);
            case "ADDINT":
            return nextInstruction(_U.replace([["acc"
              ...
              s));
            case "ILabel":
            return A2(evalInstr,x._1,s);
            case "JEZ":
            return A3(conditionalJump,
              F2(function (x,y) {
                 return _U.eq(x,y);
              }),
              x._0,
            ...
            return A3(conditionalJump,
              ...
              s);
            case "Label":
            return nextInstruction(s);
            case "MOV": return A3(evalMOV,
              x._0,
              x._1,
              s);
            case "MOVINT":
            ...
            return nextInstruction(_U.replace([["acc"
              ...
              s));
            case "SAV":
            return nextInstruction(_U.replace([["bak"
                                               ,s.acc]],
              s));
            case "SUB": return A2(evalADD,
              x._0,
              s);
            case "SUBINT":
            return nextInstruction(_U.replace([["acc"
   ...
   var transferPort = F3(function (blockA,
   blockB,
   dir) {
      return function () {
         var noAction = {ctor: "_Tuple2"
                        ,_0: blockA
                        ,_1: blockB};
         return function () {
                 ...
                 {case "Just":
                    switch (_v34._0._0.ctor)
                      {case "_Tuple2":
                         switch (_v34._1.ctor)
                           {case "Just":
                              return _U.eq(_v34._0._0._0,
                                $Common.inverseDirection(_v34._1._0)) && (_U.eq(blockA.mode,
                                $Common.PortWait) && _U.eq(blockB.mode,
                                $Common.PortWait)) ? {ctor: "_Tuple2"
                                                     ,_0: nextInstruction(_U.replace([["outPort"
                                                                                      ,$Maybe.Nothing]],
                                                     blockA))
                                                     ,_1: $eval(_U.replace([["waitPort"
                                                                            ,$Maybe.Nothing]
                                                                           ,["inPort"
                                                                            ,$Maybe.Just({ctor: "_Tuple2"
                                                                                         ,_0: _v34._1._0
   ...
   var updateConnections = F2(function (connections,
   blocks) {
      return function () {
         var go = F2(function (c,bs) {
            return function () {
               var _v41 = {ctor: "_Tuple2"
                          ,_0: A2($Array.get,c.from,bs)
                          ,_1: A2($Array.get,c.to,bs)};
               switch (_v41.ctor)
               {case "_Tuple2":
                  switch (_v41._0.ctor)
                    {case "Just":
   ...
   var getLabel = function (x) {
      return function () {
         switch (x.ctor)
         {case "ILabel": return x._0;
            case "Label": return x._0;}
         return "";
      }();
   };
   var isLabel = function (x) {
      return function () {
         switch (x.ctor)
         {case "ILabel": return true;
            case "Label": return true;}
         return false;
      }();
   };
   var loadInstructions = function (list$) {
      return function () {
         var go = F2(function (x,
         _v54) {
            return function () {
               switch (_v54.ctor)
               {case "_Tuple3":
                  return isLabel(x.instr) ? {ctor: "_Tuple3"
                                            ,_0: _v54._0
                                            ,_1: _v54._1
                                            ,_2: A2($Basics._op["++"],
                                            _v54._2,
         ...
         var list = A2($List.filter,
         function ($) {
            return $Basics.not(F2(function (x,
            y) {
               return _U.eq(x,y);
            })($Common.NewLine)(function (_) {
               return _.instr;
            }($)));
         },
         list$);
         ...
         return _U.replace([["instrs"
                            ,$Array.fromList(mem)]
                           ,["labels"
                            ,$Dict.fromList(labels)]],
         $Common.emptyBlock);
      }();
   };
   var parseAndLoad = function (lines) {
      return function () {
         var addPosition = F2(function (n,
         x) {
            return A2($Common.DebugInstr,
            x,
            n);
         });
         var parsed = A2($List.foldl,
         F2(function (x,z) {
         ...
         $Maybe.Just(_L.fromArray([])))(A2($List.indexedMap,
         F2(function (n,x) {
            return $Maybe.map(addPosition(n))($Parser.parseWithLabels(x));
         }),
         lines));
         return function () {
            switch (parsed.ctor)
            {case "Just":
               return $Maybe.Just(loadInstructions(parsed._0));
               case "Nothing":
               return $Maybe.Nothing;}
            _U.badCase($moduleName,
   ...
   var model = function () {
      var prog4 = "mov up, acc\nadd left\nmov acc,left\n";
      var prog3 = "add left\n";
      var prog2 = "mov left,acc\nmov acc,left\nmov 1,right\n";
      var prog1 = "mov 1, acc\nswp\nmov 0,acc\n\nloop:\n mov acc,right\n swp\n add right\n jmp loop\n";
      var progs = A2($List.map,
      $String.lines,
      _L.fromArray([prog1
                   ,prog2
                   ,prog3]));
      return {_: {}
             ,blocks: $Array.fromList(concatMaybe(A2($List.map,
             parseAndLoad,
             progs)))
             ,connections: _L.fromArray([A3($Common.Connection,
                                        0,
                                        1,
                                        $Common.Right)
             ...
             ,isPaused: true
             ,isRunning: false
             ,positions: _L.fromArray([_L.fromArray([0
                                                    ,1])
                                      ,_L.fromArray([2,3])])
   ...
   model) {
      return function () {
         var next = function () {
            var blocks$ = A2($Array.map,
            $eval,
            A2(updateConnections,
            model.connections,
            model.blocks));
            return _U.replace([["blocks"
                               ,_U.eq(model.isRunning,
                               false) ? model.blocks : blocks$]
                              ,["isRunning",true]],
            model);
         }();
         return function () {
            switch (action.ctor)
            {case "ActionRun":
               return _U.replace([["isRunning"
                                  ,true]
                                 ,["isPaused",false]],
                 model);
               case "Step":
               return _U.replace([["isPaused"
                                  ,true]],
                 next);
               case "Stop":
               return _U.replace([["isRunning"
                 ...
                 model);
               case "Timed":
               return model.isRunning && $Basics.not(model.isPaused) ? next : model;
               case "UpdateSource":
               return function () {
                    var lines = $String.lines(action._1);
                    return function () {
                       var _v72 = parseAndLoad(lines);
                       switch (_v72.ctor)
                       {case "Just":
                          return _U.replace([["blocks"
                                             ,A3($Array.set,
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,evalADD: evalADD
                      ,evalMOV: evalMOV
                      ,setPortOrWait: setPortOrWait
                      ,getPortOrWait: getPortOrWait
                      ,conditionalJump: conditionalJump
                      ,jumpToLabel: jumpToLabel
                      ,nextInstruction: nextInstruction
                      ,resetBlockState: resetBlockState
                      ,Model: Model
                      ,parseAndLoad: parseAndLoad
                      ,concatMaybe: concatMaybe
                      ,model: model
...
Elm.Parser.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var parseSource = function (x) {
      return function () {
         switch (x)
         {case "ACC":
            return $Maybe.Just($Common.Acc);
            case "DOWN":
            return $Maybe.Just($Common.Port($Common.Down));
            case "LEFT":
            return $Maybe.Just($Common.Port($Common.Left));
            case "RIGHT":
            return $Maybe.Just($Common.Port($Common.Right));
            case "UP":
            return $Maybe.Just($Common.Port($Common.Up));}
         return $Maybe.Nothing;
      }();
   };
   var parseMOV = function (line) {
      return function () {
         var _v1 = $List.map($String.trim)(A2($String.split,
         ",",
         line));
         switch (_v1.ctor)
                 ...
                 switch (_v1._1._1.ctor)
                   {case "[]":
                      return A2($String.all,
                        $Char.isDigit,
                        _v1._0) ? A2($Maybe.andThen,
                        $Result.toMaybe($String.toInt(_v1._0)),
                        function (x) {
                           return A2($Maybe.map,
                           $Common.MOVINT(x),
                           parseSource(_v1._1._0));
                        }) : A2($Maybe.andThen,
                        parseSource(_v1._0),
                        function (x) {
                           return A2($Maybe.map,
         ...
         {case "::":
            switch (list._1.ctor)
              {case "[]":
                 return A2($String.all,
                   $Char.isDigit,
                   list._0) ? $Maybe.map($Common.SUBINT)($Result.toMaybe($String.toInt(list._0))) : A2($Maybe.map,
                   $Common.SUB,
                   parseSource(list._0));}
              break;}
         return $Maybe.Nothing;
         ...
         {case "::":
            switch (list._1.ctor)
              {case "[]":
                 return A2($String.all,
                   $Char.isDigit,
                   list._0) ? $Maybe.map($Common.ADDINT)($Result.toMaybe($String.toInt(list._0))) : A2($Maybe.map,
                   $Common.ADD,
                   parseSource(list._0));}
              break;}
         return $Maybe.Nothing;
   ...
   var trimSplit = function (s) {
      return function ($) {
         return $List.filter(function ($) {
            return $Basics.not($String.isEmpty($));
         })($List.map($String.trim)($String.split(s)($)));
      };
   };
   var parseInstr = function (line) {
      return function () {
         var _v12 = trimSplit(" ")($String.toUpper(line));
         switch (_v12.ctor)
         {case "::": switch (_v12._0)
              {case "ADD":
                 return parseADD(_v12._1);
                 case "JEZ":
                 switch (_v12._1.ctor)
                   {case "::":
                      switch (_v12._1._1.ctor)
                        {case "[]":
                           return $Maybe.Just($Common.JEZ(_v12._1._0));}
                        break;}
                   break;
                 case "JGZ":
                 switch (_v12._1.ctor)
                   {case "::":
                      switch (_v12._1._1.ctor)
                        {case "[]":
                           return $Maybe.Just($Common.JGZ(_v12._1._0));}
                        break;}
                   break;
                 case "JLZ":
                 switch (_v12._1.ctor)
                   {case "::":
                      switch (_v12._1._1.ctor)
                        {case "[]":
                           return $Maybe.Just($Common.JLZ(_v12._1._0));}
                        break;}
                   break;
                 case "JMP":
                 switch (_v12._1.ctor)
                   {case "::":
                      switch (_v12._1._1.ctor)
                        {case "[]":
                           return $Maybe.Just($Common.JMP(_v12._1._0));}
                        break;}
                   break;
                 case "JNZ":
                 switch (_v12._1.ctor)
                   {case "::":
                      switch (_v12._1._1.ctor)
                        {case "[]":
                           return $Maybe.Just($Common.JNZ(_v12._1._0));}
                        break;}
                   break;
                 case "MOV":
                 return parseMOV($String.concat(_v12._1));
                 case "SAV":
                 return $Maybe.Just($Common.SAV);
                 case "SUB":
                 return parseSUB(_v12._1);
                 case "SWP":
                 return $Maybe.Just($Common.SWP);}
              break;
            case "[]":
            return $Maybe.Just($Common.NewLine);}
         return $Maybe.Nothing;
      }();
   };
   var parseWithLabels = function (line) {
      return function () {
         var _v25 = A2($String.indexes,
         ":",
         line);
         switch (_v25.ctor)
         {case "::":
            switch (_v25._1.ctor)
              {case "[]": return function () {
                      ...
                      {case "::":
                         switch (_v28._1.ctor)
                           {case "::":
                              switch (_v28._1._1.ctor)
                                {case "[]":
                                   return A2($Maybe.map,
                                     $Common.ILabel($String.toUpper(_v28._0)),
                                     parseInstr(_v28._1._0));}
                                break;
                              case "[]":
                              return $Maybe.Just($Common.Label($String.toUpper(_v28._0)));}
                           break;}
                      _U.badCase($moduleName,
   ...
   _L.fromArray(["SAV"
                ...
                ,"label3:"
                ,"label4:sav"]));
   var main = $Html.text($Basics.toString(test1));
   _elm.Parser.values = {_op: _op
                        ,trimSplit: trimSplit
                        ,parseWithLabels: parseWithLabels
...
Elm.View.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var UpdateSource = F2(function (a,
   b) {
      return {ctor: "UpdateSource"
             ,_0: a
             ,_1: b};
   });
   var Stop = {ctor: "Stop"};
   var Timed = {ctor: "Timed"};
   var ActionRun = {ctor: "ActionRun"};
   var Step = {ctor: "Step"};
   var help = A2($Html.div,
   _L.fromArray([$Html$Attributes.$class("help")]),
   _L.fromArray([A2($Html.code,
   _L.fromArray([]),
   _L.fromArray([$Html.text("MOV 5, ACC")]))]));
   var directionToArrow = function (dir) {
      return function () {
         switch (dir.ctor)
         {case "Down": return "↓";
            case "Left": return "←";
   ...
   var showWaitPort = function (s) {
      return function () {
         var list = function () {
            var _v1 = s.waitPort;
            switch (_v1.ctor)
            {case "Just":
               return _L.fromArray([$Html.text($Basics.toString(s.mode))
                                   ,$Html.text("?")
                                   ,A2($Html.span,
                                   _L.fromArray([$Html$Attributes.$class("arrow")]),
                                   _L.fromArray([$Html.text(directionToArrow(_v1._0))]))]);
               case "Nothing":
               return _L.fromArray([]);}
            _U.badCase($moduleName,
         ...
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("wait-port")]),
         list);
      }();
   };
   var showOutPort = function (s) {
      return function () {
         var list = function () {
            var _v3 = s.outPort;
            switch (_v3.ctor)
               ...
               switch (_v3._0.ctor)
                 {case "_Tuple2":
                    return _L.fromArray([$Html.text($Basics.toString(s.mode))
                                        ,A2($Html.span,
                                        _L.fromArray([$Html$Attributes.$class("arrow")]),
                                        _L.fromArray([$Html.text(directionToArrow(_v3._0._0))]))
                                        ,$Html.text($Basics.toString(_v3._0._1))]);}
                 break;
               case "Nothing":
               return _L.fromArray([]);}
            _U.badCase($moduleName,
            "between lines 80 and 86");
         }();
         return A2($Html.div,
         _L.fromArray([$Html$Attributes.$class("out-port")]),
         list);
      }();
   };
   var showInstr = function (x) {
      return function () {
         switch (x.ctor)
         {case "ADD": switch (x._0.ctor)
              {case "Acc": return "ADD ACC";}
              break;
            case "ADDINT":
            return A2($Basics._op["++"],
              _U.cmp(x._0,
              ...
              A2($Basics._op["++"],
              " ",
              $Basics.toString($Basics.abs(x._0))));
            case "ILabel":
            return A2($Basics._op["++"],
              x._0,
              A2($Basics._op["++"],
            ...
            return A2($Basics._op["++"],
              x._0,
              ":");
            case "MOV": switch (x._0.ctor)
              {case "Acc": switch (x._1.ctor)
                   {case "Port":
                      return A2($Basics._op["++"],
                        "MOV ACC, ",
                        $Basics.toString(x._1._0));}
                   break;}
              break;
            case "MOVINT":
            switch (x._1.ctor)
   ...
   var cssClassForInstr = function (x) {
      return function () {
         switch (x.ctor)
         {case "ILabel": return "label";
            case "JEZ": return "jump";
            case "JGZ": return "jump";
            case "JLZ": return "jump";
            case "JMP": return "jump";
            case "JNZ": return "jump";
            case "Label": return "label";}
         return "";
      }();
   };
   var showSource = F2(function (list,
   s) {
      return A2($Html.ul,
      ...
      F2(function (i,x) {
         return A2($Html.pre,
         _L.fromArray([$Html$Attributes.style(_U.eq(i,
                      $Common.getSourcePos(s)) ? _L.fromArray([{ctor: "_Tuple2"
                                                               ,_0: "color"
                                                               ,_1: "white"}
                                                              ,{ctor: "_Tuple2"
                                                               ,_0: "background"
                                                               ,_1: "black"}]) : _L.fromArray([]))
                      ,$Html$Attributes.$class(_U.eq(i,
                      $Common.getSourcePos(s)) ? " current" : "")]),
         _L.fromArray([$Html.text(_U.eq(x,
         "") ? " " : x)]));
      }),
      list));
   });
   var showBlock = F4(function (isRunning,
   address,
   idx,
   _v32) {
      return function () {
         ...
         {case "_Tuple2":
            return A2($Html.div,
              ...
              _L.fromArray([A2($Html.div,
                           _L.fromArray([$Html$Attributes.$class("registers")]),
                           _L.fromArray([A2($Html.h4,
                                        _L.fromArray([]),
                                        _L.fromArray([$Html.text(A2($Basics._op["++"],
                                        "ACC ",
                                        $Basics.toString(_v32._1.acc)))]))
                                        ,A2($Html.h4,
                                        _L.fromArray([]),
                                        _L.fromArray([$Html.text(A2($Basics._op["++"],
                                        "BAK ",
                                        $Basics.toString(_v32._1.bak)))]))
                                        ,showOutPort(_v32._1)
                                        ,showWaitPort(_v32._1)]))
                           ,A2($Html.div,
                           _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                              ,_0: "display"
                                                                              ,_1: "none"}]))]),
                           _L.fromArray([$Html.text($Basics.toString(_v32._1.instrs))]))
                           ,A2($Html.div,
                           _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                              ,_0: "display"
                                                                              ,_1: "none"}]))]),
                           _L.fromArray([$Html.text($Basics.toString(_v32._1.labels))]))
                           ,$Basics.not(isRunning) ? A2($Html.textarea,
                           _L.fromArray([$Html$Attributes.rows(10)
                                        ,$Html$Attributes.cols(20)
                                        ,A3($Html$Events.on,
                                        "input",
                                        $Html$Events.targetValue,
                                        function ($) {
                                           return $Signal.message(address)(UpdateSource(idx)($));
                                        })]),
                           _L.fromArray([$Html.text(A2($String.join,
                           "\n",
                           _v32._0))])) : A2(showSource,
                           _v32._0,
                           _v32._1)]));}
         _U.badCase($moduleName,
         "between lines 57 and 77");
      }();
   });
   ...
   model) {
      ...
      _L.fromArray([A2($Html.div,
                   ...
                   $Array.toList(model.sources),
                   $Array.toList(model.blocks))))]));
   });
   var showInstrs = function (s) {
      return A2($Html.ul,
      _L.fromArray([$Html$Attributes.$class("instructions")]),
      A2($List.indexedMap,
      F2(function (i,x) {
         return A2($Html.li,
         _L.fromArray([$Html$Attributes.style(_U.eq(i,
                      s.cur) ? _L.fromArray([{ctor: "_Tuple2"
                                             ,_0: "color"
                                             ,_1: "white"}
                                            ,{ctor: "_Tuple2"
                                             ,_0: "background"
                      ...
                      cssClassForInstr(x.instr),
                      _U.eq(i,
                      s.cur) ? " current" : ""))]),
         _L.fromArray([$Html.text(showInstr(x.instr))
                      ,$Html.text("|")
                      ,$Html.text($Basics.toString(x.line))]));
      }),
      $Array.toList(s.instrs)));
   };
   _elm.View.values = {_op: _op
                      ,showInstrs: showInstrs
                      ,showSource: showSource
                      ,cssClassForInstr: cssClassForInstr
                      ,showInstr: showInstr
                      ,showBlock: showBlock
                      ,showOutPort: showOutPort
                      ,showWaitPort: showWaitPort
                      ,directionToArrow: directionToArrow
                      ,help: help
                      ,view: view
                      ,Step: Step
                      ,ActionRun: ActionRun
